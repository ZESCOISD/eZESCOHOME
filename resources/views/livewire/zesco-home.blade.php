                                             ...
                                             <div class="card card-animated" id="search-cards">
                                                 <a class="card-link">
                                                     <div class="card-body" id="index-card-body">
                                                         ...
                                                         <p id="index-card-text" class="card-text mt-4 bg-danger">No
                                                             results
                                                             found</p>
                                                     </div>
                                                 </a>
                         ...
                         <div class="padding">
                             <div class="full col-sm-9">
                                             ...
                                             <div class="container" data-aos="fade-up" data-aos-delay="100">
                                                 ...
                                                 <div class="row align-items-xl-center gy-5">
                                                     ...
                                                     <div class="col-xl-5 content">
                                                         ...
                                                         <p>Know more about Zesco's in-house system's. Click the
                                                             link
                                                             below
                                                             to get started.
                                                         </p>
                                 ...
                                 <footer class="page-footer  font-small blue">
                                     <div id="footer-text" class="footer-copyright text-center"> Copyright ©
                                         2022-2025
