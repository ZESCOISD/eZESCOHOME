            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="row">
                        ...
                        <style> #resetpassword-section{ display: none; }</style>
                            <div class="row">
                     
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 d-flex justify-content-center align-items-center">
          
                                  <div class="card shadow bg-white justify-content-center align-items-center" id="resetpassworcard">
                                      <div class="card-body text-center">
                                          <div class="text-center">
                                          <img src="/img/Zesco.png" alt="Welcome note" id="card-logo" width="190px">
                                          </div>
                                          <div class="alert alert-success">{{ $successMessage }}</div>
                                  <a type="submit" onclick=" window.location='{{ route('login') }}'" id="forgotPass"><p class="mt-3">Go To Login Page</p></a>
                        ...
                        <div class="card shadow bg-white justify-content-center align-items-center" id="resetpassworcard">
                            <div class="card-body text-center">
                                ...
                                <form wire:submit.prevent="resetPassword">
                                  ...
                                  <div class="input-group">
                                    <input type="password" class="form-control form-rounded" wire:model.defer="password_confirmation" name="password_confirmation" placeholder="Confirm Password" required>
                                  ...
                                  <button class="btn btn-primary form-rounded" type="submit" name="submit">Reset Password</button>
