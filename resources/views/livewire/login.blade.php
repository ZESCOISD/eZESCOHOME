                        ...
                        <div class="card shadow bg-white justify-content-center align-items-center" id="card">
                            <div class="card-body text-center">
                                ...
                                <form wire:submit.prevent="login">
                                  ...
                                  <button class="btn btn-primary form-rounded" type="submit" name="submit">Login</button>
                                  ...
                                  <a type="submit" onclick=" window.location='{{ route('forgot-password') }}'"  id="forgotPass"><p class="mt-3">Forgot Password?</p></a>
                                  </div>
                            </form>
                            </div>
                        </div>
