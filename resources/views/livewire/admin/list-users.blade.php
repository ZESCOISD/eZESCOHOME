                                ...
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link {{ $activeTab === 'tab1' ? 'active' : '' }}"  
                                           wire:click="$set('activeTab', 'tab1')" href="#" role="tab" 
                                            >Users</a>
                                    </li>
                                    @endrole
                                    <li class="nav-item">
                                        <a class="nav-link {{ $activeTab === 'tab2' ? 'active' : '' }}"  
                                            wire:click="$set('activeTab', 'tab2')" href="#" role="tab" 
                                            >Manage Password</a>
                                    </li>
                                ...
                                <div class="tab-content">
                                            ...
                                            <div class="table-wrapper">
                                                <div class="table-title">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <input class="form-control border-end-0 border rounded-pill" wire:model="search" type="search"
                                                                placeholder="Enter ID..." name="id" id="search-input">
                                                                            ...
                                                                            <form wire:submit.prevent="register">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="number" class="form-control mb-1"
                                                                                        wire:model.defer="staff_number" id="name" placeholder="staff number"
                                                                                        required>
                                                                                    @error('staff_number')
                                                                                    <span class="text-danger">{{ $message }}</span>
                                                                                    @enderror
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="#editUserModal" class="edit" data-toggle="modal" data-target="#updateUserModal"
                                                                    wire:click="editUser({{ $user->user_id }})"><i class="material-icons" data-toggle="tooltip"
                                                                        title="Edit">&#xE254;</i></a>
                                               
                                                                
                                                                <a href="#deleteUserModal" class="delete" data-toggle="modal" data-target="#deleteUserModal"
                                    ...
                                    <div class="tab-pane  {{ $activeTab === 'tab2' ? 'active' : '' }}" id="tab2"  role="tabpanel"
                                        ...
                                        <form wire:submit.prevent="updatePassword">
                                            ...
                                            <div class="form-group">
                                                <label for="name">staff number</label>
                                                <input type="number" class="form-control mb-3" wire:model.defer="update_staff_number" id="name"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control mb-3" wire:model.defer="update_password"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control mb-3"
                                                    wire:model.defer="update_password_confirmation" id="update_password_confirmation"
                                                    placeholder="confirm password" required>
                                                @error('password_confirmation')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
