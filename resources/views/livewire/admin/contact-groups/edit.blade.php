...
{{-- Updates the modal --}}
<div wire:ignore.self class="modal fade" id="updateContactGroupModal" tabindex="-1" role="dialog"
     aria-labelledby="updateContactGroupModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="updateContactGroupModalLabel">Update Contact Group</h5>
                <button id="modal-close" type="button" class="close" wire:click="closeModal"
                        data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div wire:loading wire:target="updateContactGroup" class="loading-bar"></div>
            ...
            <div class="modal-body">
                ...
                @endif
                <form wire:submit.prevent="updateContactGroup">
                    @csrf
