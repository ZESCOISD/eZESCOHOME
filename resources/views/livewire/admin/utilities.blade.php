                ...
                <div wire:ignore.self class="card">
                    <div class="card-header p-2">
                        <ul class="nav nav-pills">
                            ...
                            <li class="nav-item"><a class="nav-link" href="#carousel" data-toggle="tab">Home
                                    Carousel</a>

                            </li>
                            <li class="nav-item"><a class="nav-link" href="#suggestion_box" data-toggle="tab">Suggestion
                                    Box</a>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form wire:submit.prevent="editNotice">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                wire:model.defer="notice_name" required>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Description</label>
                                                            <input type="text" class="form-control"
                                                                wire:model.defer="description" required>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Staff Name</label>
                                                            <input type="text" class="form-control"
                                                                wire:model.defer="staff_name" required>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Position Of Staff</label>
                                                            <input type="text" class="form-control"
                                                                wire:model.defer="staff_title" required>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Department Of Stuff</label>
                                                            <input type="text" class="form-control"
                                                                wire:model.defer="department" required>
                                                        </div>
                                                        <div class="form-group">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <input style="background-color: rgb(153, 150, 150)"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">">
                                            <div class="modal-content">
                                                ...
                                                <form wire:submit.prevent="destroyNotice">
                                                    ...
                                                    <div class="modal-footer">
                                                        <input id="del"
                                                            style="background-color: red; color:white;" type="submit"
                                                            class="btn btn-danger" value="Delete">
                                                        <input style="background-color: grey; color:white;"
                                                            type="button" class="btn btn-default"
                                                            wire:click="closeModal" data-dismiss="modal"
                                                            value="Cancel">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body ">
                                                                    @if (session()->has('savesuccessful'))
                                                                        <div id="dismiss"
                                                                            ...
                                                                            <p class="mt-3">
                                                                                {{ session('savesuccessful') }}</p>
                                                                            <button style="color:white;"
                                                                                type="button" class="btn-close mt-1"
                                                                                data-dismiss="alert"
                                                                                wire:click="closeModal"
                                                                                aria-label="Close">
                                                                            </button>
                                                                    ...
                                                                    <form wire:submit.prevent="saveNotice">
                                                                        ...
                                                                        <div class="modal-footer mt-3 text-center"
                                                                            id="modal-footer">
                                                                            <button style="background-color: #1bad6c"
                                                                                type="submit"
                                                                                class="btn btn-danger">submit</button>
                                                                            <button
                                                                                style="background-color: rgb(153, 150, 150)"
                                                ...
                                                @forelse($upcoming_events as $upcoming_event)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @role('admin')
                                                                <a type="button" href="#updateNoticeModal"
                                                                    data-toggle="modal" data-target="#updateNoticeModal"
                                                                    wire:click="editNotice({{ $notice->id }})"
                                                                    class="edit"><i class="material-icons"
                                                                        data-toggle="tooltip"
                                                                        title="Edit">&#xE254;</i></a>
                                    ...
                                    <div class="table-wrapper">
                                        <div class="table-title mb-5">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                    <input class="form-control border-end-0 border rounded-pill"
                                                        wire:model.defer="search_faq" type="search"
                                                        placeholder="Search..." id="search-input">
                                                ...
                                                <div class="col-sm-4">
                                                    ...
                                                    @role('admin')
                                                        <button id="btn-add-new" type="button" class="btn btn-primary"
                                                            data-toggle="modal" data-target="#addFaqModal"><i
                                                                class="material-icons">&#xE147;</i> <span>Add New
                                                                Faq</span></button>
                                                    @endrole
                                                    <div wire:ignore.self class="modal fade" id="addFaqModal"
                                                        tabindex="-1" role="dialog"
                                                        ...
                                                        <div class="modal-dialog modal-lg" style="max-width: 80%;"
                                                            ...
                                                            <div class="modal-content">
                                                                <div style="background-color:cadetblue; color:white;"
                                                                    class="modal-header">
                                                                    <h5 class="modal-title text-white"
                                                                        id="addFaqModalLabel">Enter notice
                                                                        details</h5>
                                                                    <button id="modal-close" wire:click="closeModal"
                                                                        type="button" class="close"
                                                                        data-dismiss="modal" aria-label="Close">
                                                                ...
                                                                <div wire:loading wire:target="saveFaq"
                                                                    class="loading-bar"></div>
                                                                <div class="modal-body ">
                                                                    @if (session()->has('savesuccessful'))
                                                                        <div id="dismiss"
                                                                    ...
                                                                    <form wire:submit.prevent="saveFaq">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="faq_answer">Event
                                                                                Description</label>
                                                                            <textarea name="description" wire:model.defer="answer" id="faq_answer" class="form-control mb-1" cols="30"
                                            ...
                                            <form wire:submit.prevent="editFaq">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            wire:model.defer="question" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Answer</label>
                                                        <input type="text" class="form-control"
                                                            wire:model.defer="answer" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Date</label>
                                                        <input type="date" class="form-control"
                                    ...
                                    <div class="table-wrapper">
                                        <div class="table-title mb-5">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                    <input class="form-control border-end-0 border rounded-pill"
                                                        wire:model.defer="search_carousel" type="search"
                                                        placeholder="Search..." id="search-input">
                                                ...
                                                <div class="col-sm-4">
                                                    ...
                                                    @role('admin')
                                                        <button id="btn-add-new" type="button" class="btn btn-primary"
                                                            data-toggle="modal" data-target="#addSlideModal"><i
                                                                class="material-icons">&#xE147;</i> <span>Add New
                                                                Slide</span></button>
                                                    @endrole
                                                    <div wire:ignore.self class="modal fade" id="addSlideModal"
                                                        tabindex="-1" role="dialog"
                                                        ...
                                                        <div class="modal-dialog modal-lg" style="max-width: 80%;"
                                                            ...
                                                            <div class="modal-content">
                                                                <div style="background-color:cadetblue; color:white;"
                                                                    class="modal-header">
                                                                    <h5 class="modal-title text-white"
                                                                        id="addSlideModalLabel">Enter notice
                                                                        details</h5>
                                                                    <button id="modal-close" wire:click="closeModal"
                                                                        type="button" class="close"
                                                                        data-dismiss="modal" aria-label="Close">
                                                                ...
                                                                <div wire:loading wire:target="saveSlide"
                                                                    class="loading-bar"></div>
                                                                <div class="modal-body ">
                                                                    @if (session()->has('savesuccessful'))
                                                                        <div id="dismiss"
                                            ...
                                            <tbody>
                                                ...
                                                @forelse($slides as $slide)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @role('admin')
                                                                <a type="button" href="#updateSlideModal"
                                                                    data-toggle="modal" data-target="#updateSlideModal"
                                                                    wire:click="editSlide({{ $slide->id }})"
                                                                    class="edit"><i class="material-icons"
                                                                        data-toggle="tooltip"
                                                                        title="Edit">&#xE254;</i></a>
                                                                <a type="button" href="#deleteSlideModal"
                                            ...
                                            <form wire:submit.prevent="editSlide">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Image</label>
                                                        <input type="text" class="form-control"
                                                            wire:model.defer="image" required>
                                                    </div>
                                    ...
                                    <div class="table-wrapper">
                                        <div class="table-title mb-5">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                    <input class="form-control border-end-0 border rounded-pill"
                                                        wire:model.defer="search_suggestion" type="search"
                                                        placeholder="Search..." id="search-input">
                                            ...
                                            <tbody>
                                                ...
                                                @forelse($suggestions as $suggestion)
                                                    <tr>
                                                        ...
                                                        <a type="button" href="#viewModal" data-toggle="modal"
                                                            data-target="#viewModal"
                                                            wire:click.prevent="viewItem({{ $suggestion->id }})"><i
                                                                class="bi bi-eye-fill"></i></a>
                                                        @role('admin')
                                                            <a type="button" href="#deleteSuggestionModal"
                                                                data-toggle="modal" data-target="#deleteSuggestionModal"
                                                            ...
                                                            <div class=" mb-2">
                                                                <div class="-body">
                                                                    <i style="font-size:25px;"
                                                                        class="bi bi-filter-square-fill"></i>
                                                                    <h5>Subject</h5>
                                                                    <input style="width:300px;"
                                                                        class="text-center p-2"
                                                                        id="view-item-inputs" type="text"
                                                                        form-group wire:model.prevent="subject"
                                                                        readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class=" mb-2">
                                                                <div class="-body">
                                                                    ...
                                                                    <input style="overflow-x: scroll;"
                                                                        class="text-center p-2"
                                                                        id="view-item-inputs" type="text"
                                                                        form-group wire:model.prevent="system_name"
                                                                        readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class=" mb-2">
                                                                <div class="-body">
                                                                    ...
                                                                    <input id="view-item-inputs"
                                                                        class="text-center p-2" type="text"
                                                                        form-group wire:model.prevent="created_at"
                                                                        readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">">
                                        <div class="modal-content">
                                            ...
                                            <form wire:submit.prevent="destroySuggestion">
                                                ...
                                                <div wire:loading wire:target="destroySuggestion"
                                                    class="loading-bar">
                                                </div>
                                                <div class="modal-body">
                                                    @if (session()->has('deletesuccessful'))
