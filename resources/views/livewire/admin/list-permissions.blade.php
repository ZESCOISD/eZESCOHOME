    ...
    <body id="manage-body">
        ...
        <div class="container">
            <div class="table-wrapper mt-5">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <button id="btn-add-new" type="button" class="btn btn-primary" data-toggle="modal" data-target="#addPermissionModal"><i class="material-icons">&#xE147;</i> <span>Add New Permission</span></button>
    
                            <div wire:ignore.self  class="modal fade"  id="addPermissionModal"  tabindex="-1" role="dialog" aria-labelledby="addPermissionModalLabel" aria-hidden="true">
                            <div  class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="addPermissionModalLabel">Enter permission details</h5>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#editPermissionModal" class="edit" data-toggle="modal" data-target="#updatePermissionModal" wire:click="editPermission({{$permission->id}})"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                <a href="#deletePermissionModal" class="delete" data-toggle="modal" data-target="#deletePermissionModal" wire:click="deletePermission({{$permission->id}})"><i class="material-icons" data-toggle="tooltip" wire:click="closeModal" title="Delete">&#xE872;</i></a>
                            </td>
                        </tr>
                        @empty
                        <tr>
                ...
                <!-- Edit Modal HTML -->
    <!-- Edit Modal HTML -->
        <div wire:ignore.self  class="modal fade"  id="editPermissionModal"  tabindex="-1" role="dialog" aria-labelledby="editPermissionModalLabel" aria-hidden="true">
            <div  class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                <div class="modal-header">
                ...
                <div  class="modal-body">
                    ...
                    <div class="alert alert-success mt-3 text-bg-success p-2 text-center" style="border:none; font-size: 12px;">
                        <p class="mt-3">{{ session('updatesuccessful') }}</p></div>
                @endif
            ...
            {{-- Updates the modal --}}
            <div wire:ignore.self  class="modal fade"  id="updatePermissionModal"  tabindex="-1" role="dialog" aria-labelledby="updatePermissionModalLabel" aria-hidden="true">
                <div  class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <form wire:submit.prevent="destroyPermission">
                           ...
                           <div wire:loading wire:target="destroyPermission" class="loading-bar"></div>
                            ...
                            <div class="modal-body">
                                ...
                                <div id="dismiss" class="alert alert-info mt-3 text-bg-success  p-2 text-center" style="border:none; font-size: 12px;">
