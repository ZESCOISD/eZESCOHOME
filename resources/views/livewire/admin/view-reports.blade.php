<div>
    ...
    <body id="report-body">
        ...
        <form wire:submit.prevent="searching">
            ...
            <div class="row m-2">
                <div class="col-lg-2 mt-3">
                    <select class="form-select" wire:model.defer="selectedReportType"
                ...
                <div class="col-lg-2 mt-3">
                    <input style="width: 250px" type="text" id="report-serach-field" wire:model.defer="search"
                ...
                <div class="col-lg-2 mt-3">
                    ...
                    <button style="width: 150px; background-color:cornflowerblue; color:white;" type="submit"
                        id="submitButton" wire:click="searching" class="form-control">search</button>
                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <table id="dtBasicExample" class="table table-striped table-bordered table-sm responsive"
                                ...
                                @if (count($suggestions) > 0)
                                    @foreach ($suggestions as $suggestion)
                                        <tr>
                                            ...
                                            <td>
                                                <a type="button" href="#viewSuggestionModal" data-toggle="modal"
                                                    data-target="#viewSuggestionModal"
                                                    wire:click.prevent="viewSuggestion({{ $suggestion->id }})"><i
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a type="button" href="#viewModal" data-toggle="modal"
                                                    ...
                                                    wire:click.prevent="viewItem({{ $product['product_id'] }})"><i
                                                        class="bi bi-eye-fill"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    ...
                                    <div class=" mb-2">
                                        <div class="-body">
                                            ...
                                            <input style="width:300px;" class="text-center p-2" id="view-item-inputs"
                                                type="text" form-group wire:model.prevent="name" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class=" mb-2">
                                        <div class="-body">
                                            ...
                                            <input style="overflow-x: scroll;" class="text-center p-2"
                                                ...
                                                wire:model.prevent="category_name" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-6">
                                    <div class=" mb-2">
                                        <div class="-body">
                                            ...
                                            <input style="overflow-x: scroll;" class="text-center p-2"
                                                id="view-item-inputs" type="text" form-group
                                                wire:model.prevent="status_name" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class=" mb-2">
                                        <div class="-body">
                                            ...
                                            <input style="width:300px;" class="text-center p-2" id="view-item-inputs"
                                                type="text" form-group wire:model.prevent="lead_developer"
                                                readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class=" mb-2">
                                        <div class="-body">
                                            ...
                                            <h5>Product Url</h5>
                                            <input style="overflow-x: scroll; width:300px;" class="text-center p-2"
                                                id="view-item-inputs" type="text" form-group
                                                wire:model.prevent="url" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class=" mb-2">
                                        <div class="-body">
                                            ...
                                            <h5>Test Url</h5>
                                            <input style="width:300px;" class="text-center p-2" id="view-item-inputs"
                                                type="text" form-group wire:model.prevent="test_url" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class=" mb-2">
                                        <div class="-body">
                                            ...
                                            <textarea style="width:300px;" class="text-center p-2" id="view-item-inputs" type="text" form-group
                                                wire:model.prevent="short_description" readonly>
                                        </textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class=" mb-2">
                                        <div class="-body">
                                            ...
                                            <textarea style="width:300px;" class="text-center p-2" id="view-item-inputs" type="text" form-group
                                                wire:model.prevent="long_description" readonly>
                                        </textarea>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class=" mb-2">
                                        <div class="-body">
                                            ...
                                            <input id="view-item-inputs" class="text-center p-2" type="text"
                                                form-group wire:model.prevent="date_launched" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class=" mb-2">
                                        <div class="-body">
                                            ...
                                            <input id="view-item-inputs" class="text-center p-2" type="text"
                                                form-group wire:model.prevent="date_decommissioned" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
