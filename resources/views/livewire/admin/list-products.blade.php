                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mt-2">
                                            <div class="form-group mt-2">
                                                <label for="status_id">Product State <span class="text-danger">*</span></label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mt-2">
                                            <div class="form-group ">
                                                ...
                                                <div wire:ignore >
                                                    <select class="form-control js-example-basic-single" id="developers"
                                                            multiple="multiple"  name="developers" required  >
