                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a wire:ignore href="#viewRoleModal" class="view" data-toggle="modal" data-target="#assignRoleModal" wire:click="viewRole({{$role->name}})"><i class="bi bi-eye-fill"></i></a>
                                </td>
                            </tr>
                            @empty
                            <tr>
                    ...
                    <div  class="modal-body">
                        ...
                        <form wire:submit.prevent="editRole">
                            ...
                            <div class="form-group m-2">
                                <select style="width:250px; height:40px;" name="permission_name" id="permissions" wire:model.defer="permission_name">
                        ...
                        <!-- Add Permission -->
            <div wire:ignore.self  class="modal fade"  id="assignRoleModal"  tabindex="-1" role="dialog" aria-labelledby="editRoleModalLabel" aria-hidden="true">
                <div  class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                    <div class="modal-header">
