    ...
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <form class="form-inline my-2 my-lg-0">
            <div class="input-group">
                <input wire:model="nav_search" wire:keydown.debounce.300ms="navSearch" class="form-control"
                    type="search" placeholder="Search system" aria-label="Search">
        ...
        <nav id="navbar" class="navbar">
            <ul>
                ...
                <li class="dropdown"><a href="#"><span>Systems By Categories</span> <i
                            class="bi bi-chevron-down"></i></a>
                    <ul>
                        @foreach ($categories as $category)
                            <li class="dropdown"><a href="#"><span>{{ $category->name }}
                                        ({{ $category->products->count() }})</span> <i
