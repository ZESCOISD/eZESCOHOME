...
<footer id="footer">
    <div class="container">
        <h3>E-ZESCO HOME</h3>
        <p>Your central platform for accessing a wide range of seamlessly integrated and developed systems, simplifying
            your Zesco online experience .</p>
                                ...
                                <div>
                                    ...
                                    <h6 style="color:black"> Importance Of Your Feedback</h3>
                                        <h7 class="mb-4 mt-1 text-sm" style="color:black">
                                            We invite you to join our group of change-makers and contribute your
                                            thoughts to help shape

                                            the company.We believe that every idea has the potential to be a
                                            game-changer. By utilizing our
                                            online
                                            suggestion box, you gain a platform that amplifies your voice and ensures
                                            your input reaches the
                                            decision-makers who can turn your suggestions into reality.
                                            </h5>
                                            <hr style="color:green">
                                            <h6 style="color:#d86100" class="text-bold">Suggest areas of system
                                                improvement to enhance and make Zesco system's better </h6>
                                            <hr style="color:green">
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="mb-3">
                                                    <input name="system_name" type="text" class="form-control"
                                                        placeholder="Proposed System name" required>
                                                </div>
                                            </div>
                                        </div>
        ...
        <div class="credits">
            Designed by <a href="https://www.zesco.co.zm" target="_blank" style="color: white">Innovation and Systems
                Development Division - ICT © ZESCO Limited.</a> </p>
        </div>
    </div>
</footer><!-- End Footer -->
